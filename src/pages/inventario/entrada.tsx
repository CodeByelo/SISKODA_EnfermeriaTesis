...
import { ArrowLongLeftIcon, ArrowTrendingUpIcon } from '@heroicons/react/24/outline';
        ...
        <section className="rounded-[28px] bg-gradient-to-r from-[#1d1029] via-[#2e1742] to-[#4f2671] p-8 text-white shadow-2xl">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h1 className="mt-3 text-4xl font-semibold tracking-tight">Registrar entrada</h1>
              <p className="mt-3 max-w-2xl text-sm leading-6 text-violet-100">
                Sube existencias con el mismo lenguaje visual del resto del sistema.
              </p>
            </div>
            <button
              type="button"
        ...
        <section className="rounded-[28px] bg-white shadow-[0_24px_60px_-36px_rgba(76,29,149,0.25)]">
          <div className="border-b border-violet-100 px-8 py-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.24em] text-emerald-600">Movimiento</p>
                <h2 className="mt-1 text-2xl font-semibold text-gray-900">Entrada de insumo</h2>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 px-8 py-8">
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div>
                <label className="mb-2 block text-sm font-semibold text-gray-700">Fecha de vencimiento (opcional)</label>
                <input
            ...
            <div className="flex flex-col gap-3 pt-2 sm:flex-row">
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center rounded-2xl bg-emerald-600 px-5 py-3 text-sm font-semibold text-white shadow-lg transition hover:bg-emerald-700"
              >
                Registrar entrada
              </button>
            </div>
